	...
	let nameValidators = [
		{
			...
			message: 'Your name must be at least 2 characters but no more than 15.'
		},
		{
...
// ==========================================================
	...
	let usernameLengthChecker = (username) => {
		if(!username){
			...
			// If the length is smaller than two or longer than 15 return error.
	...
	let usernameValidators = [
		{
			...
			message: 'Your username must be at least 5 characters but no more than 15.'
		},
		{
...
// ==========================================================
	...
	let passwordLengthChecker = (password) => {
		if(!password){
			...
			// If the length is smaller than two or longer than 35 return error.
	...
	let passwordValidators = [
		{
			...
			message: 'Your password must be at least 5 characters but no more than 35.'
		},
		{
